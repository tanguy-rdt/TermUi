...
//
    ...
    #define TUI_PREFIX_EMBEDDED_PAGE_LINE CONF_TUI_PREFIX_EMBEDDED_PAGE_LINE
    #define TUI_SUFIX_EMBEDDED_PAGE_LINE  CONF_TUI_SUFIX_EMBEDDED_PAGE_LINE
    ...
    #define TUI_PREFIX_EMBEDDED_PAGE_LINE "  "
    #define TUI_SUFIX_EMBEDDED_PAGE_LINE  " --->"
